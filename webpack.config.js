...
module.exports = {
    ...
    output: {
        filename: "index.js",
        path: path.join(__dirname, "dist", "crowdrecords_assets"),
    },
    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                {
                    from: path.join(__dirname, "src", "crowdrecords_assets", "assets"),
                    to: path.join(__dirname, "dist", "crowdrecords_assets"),
                },
            ],
        }),
        new webpack.EnvironmentPlugin({
            ...
            RECORDS_CANISTER_ID: canisters["records"],
